...
import { VarShowObject, VarShowString, VarShowWord, VarShowAdjective, VarShowGrammarLine, VarShowAction, VarShowProperty } from './globshow';
...
export function GlobalVar({ index, value, origvalue }: { index:number, value:number, origvalue:number })
{
    ...
    if (vartype == null) {
        ...
        case 'WORD':
            ...
            break;
        case 'ADJ':
            vartype = <VarShowAdjective value={ value } />;
            break;
        case 'GLINE':
