...
import { unpack_address, signed_zvalue, gamedat_string_map, gamedat_dictword_addrs, gamedat_dictword_adjs, gamedat_routine_addrs, gamedat_property_nums, gamedat_attribute_nums, gamedat_global_nums } from '../custom/gamedat';
